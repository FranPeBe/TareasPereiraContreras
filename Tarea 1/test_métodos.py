# retornar_numero es una función auxiliar que tiene un condicional
# para cada número del 0 al 99 donde, si el parámetro coincide
# con el número, este retorna el nombre del número en un string.
